...
install_logioptions() {
    ...
    # Function to move Logitech files
    move_logitech_files() {
        local pattern="$1"
    ...
    # Move Logitech related files with loading bar
    echo "Moving Logitech related files..."
    {
        move_logitech_files "logitech"
        move_logitech_files "logi.options"
        move_logitech_files "LogiOptions"
        move_logitech_files "logioptions"
        move_logitech_files "LogiPlugin"
    } &
